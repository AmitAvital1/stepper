...
import static app.resources.util.Constants.EXECUTION_HISTORY;
import static app.resources.util.Constants.STATISTICS;

public class StatisticsController implements BodyControllerDefinition {
    private BodyController bodyForStatisticsController;
